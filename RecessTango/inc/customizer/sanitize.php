 ...
 */
function RecessTango_sanitize_select( $input, $setting ) {
 ...
 *                    the setting default.
 */
function RecessTango_sanitize_number_range( $number, $setting ) {
 ...
 */
function RecessTango_sanitize_checkbox( $checked ) {
 ...
 * @since RecessTango 0.01
 */
function RecessTango_sanitize_category_list( $input ) {
	if ( $input != '' ) {
		$args = array(
						'type'			=> 'post',
						'child_of'      => 0,
 ...
 * @since RecessTango 0.01
 */
function RecessTango_sanitize_dropdown_category_list( $input ) {
	if ( $input != '' ) {
		$args = array(
						'type'			=> 'post',
						'child_of'      => 0,
 ...
 */
function RecessTango_santize_allow_tag( $input ) {
...
* @return sanitized output*
*/
function RecessTango_sanitize_page( $input ) {
