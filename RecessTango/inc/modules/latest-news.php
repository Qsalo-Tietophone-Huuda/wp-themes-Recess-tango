...
if ( ! function_exists( 'RecessTango_add_latest_news_section' ) ) :
  /**
   * Add Latest news
   *
   *@since RecessTango 0.01
  ...
  function RecessTango_add_latest_news_section() {

    // Check if Search is enabled on frontpage
    $latest_news_enable = apply_filters( 'RecessTango_section_status', true, 'latest_news_enable' );
    ...
    $section_details = apply_filters( 'RecessTango_filter_latest_news_section_details', $section_details );
    ...
    RecessTango_render_latest_news_section( $section_details );
  }
endif;
add_action( 'RecessTango_primary_content', 'RecessTango_add_latest_news_section', 60 );


if ( ! function_exists( 'RecessTango_get_latest_news_section_details' ) ) :
  /**
   * Latest news details.
   *
   * @since RecessTango 0.01
   ...
   */
  function RecessTango_get_latest_news_section_details( $input ) {
    ...
    switch ( $latest_news_content_type ) {
        ...
        case 'category':
            ...
            foreach ( $all_posts as $key => $post ) {
                ...
                $content['all'][$k]['excerpt']   = RecessTango_trim_content( 28, $post  );
            ...
            foreach ( $cat_ids as $key => $cat_id ) {
                ...
                foreach( $category_posts as $category_post ){
                    ...
                    $content[$cat_id][$i]['excerpt']      = RecessTango_trim_content( 28, $category_post  );
...
add_filter( 'RecessTango_filter_latest_news_section_details', 'RecessTango_get_latest_news_section_details' );


if ( ! function_exists( 'RecessTango_render_latest_news_section' ) ) :
  /**
   * Start Latest news
   *
   ...
   *
   */
   function RecessTango_render_latest_news_section( $content_details ) {
                ...
                <div class="entry-content  wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="0.3s">
                    <div class="tab-section">
                        ...
                        <?php 
                            ...
                            if( !empty( $cat_ids ) ){
                                echo '<li class="tab-link active" data-tab="all-latest-news"><a href="#.">'. esc_html__( 'all', 'RecessTango' ) .'</a></li>';
