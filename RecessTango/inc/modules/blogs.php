 ...
 */
if ( ! function_exists( 'RecessTango_add_blogs_section' ) ) :
  /**
   * Add Blogs section
   *
   *@since RecessTango 0.1
   */
  function RecessTango_add_blogs_section() {

    // Check if blog section is enabled on frontpage
    $blogs_section_enable = apply_filters( 'RecessTango_section_status', true, 'blogs_section_enable' );
    ...
    $section_details = apply_filters( 'RecessTango_filter_blogs_section_details', $section_details );
    ...
    RecessTango_render_blogs_section( $section_details );
  }
endif;
add_action( 'RecessTango_primary_content_footer', 'RecessTango_add_blogs_section', 10 );


if ( ! function_exists( 'RecessTango_get_blogs_section_details' ) ) :
  /**
   ...
   */
    function RecessTango_get_blogs_section_details( $input ) {
...
add_filter( 'RecessTango_filter_blogs_section_details', 'RecessTango_get_blogs_section_details' );


if ( ! function_exists( 'RecessTango_render_blogs_section' ) ) :
  /**
   * Start Blogs section
   *
   ...
   *
   */
   function RecessTango_render_blogs_section( $content_details  ) {
                    ...
                    <div class="column-wrapper wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="0.5s">
                        <div class="blog-post-wrapper">
                            ...
                            <div class="blog-content">
                                ...
                                <time><?php echo date_i18n( esc_html__( 'M d, Y', 'RecessTango' ), strtotime( $content['post_date'] ) ); ?></time>
                            </div><!--.blog-content-->
